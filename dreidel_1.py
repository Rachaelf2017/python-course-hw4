...
n_start_pieces=10
player_one_pieces=10
player_two_pieces=10
pot=0
...
#     it always ends.
while (player_one_pieces> 1) and (player_two_pieces > 1) :
# while game_round < 4:
    game_round = game_round + 1
    # print "Round: %d" % game_round
    # print "Player 1 score: %s " % player_one_pieces
    # print "Player 2 score: %s " % player_two_pieces
    # print "Starting pot: %s" % pot
    print "Its " + spinner + "'s turn!"
    ...
    # print "Post-pot 1: %s " % player_one_pieces
    # print "Post-pot 2: %s " % player_two_pieces
    # print "Post-pot: %s " % pot

    # dreidel_val='nun'
    dreidel_val= spin_dreidel()
    # print "She spun a %s" % dreidel_val
    ...
    # print "Player 1 end of round score: %d" % player_one_pieces
    # print "Player 2 end of round score: %d" % player_two_pieces
    # print "Ending pot: %d" % pot

    game_state()

    if player_one_pieces < 2:
        print "Game over! Player 2 wins!"
    elif player_two_pieces < 2:
